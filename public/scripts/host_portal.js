...
var AbstractView = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(AbstractView, [{
    ...
    value: function setupMenu() {
      ...
      this.menuIndicator.addEventListener("click", function (event) {
        _this.menuArea.hidden = !_this.menuArea.hidden;
      });
      this.menuLogout.addEventListener("click", function (event) {
        _this.logout();
      });
    }
  }, {
    key: "updatePlayers",
    value: function updatePlayers(update) {
    ...
    key: "updateQuestions",
    value: function updateQuestions(update) {
      if (!update.questionSet) return;

      for (var i in update.questionSet) {
        this.gameBoard.setHeader(i, update.questionSet[i].category);

        for (var j in update.questionSet[i].questions) {
          this.gameBoard.setCell(j, i, update.questionSet[i].questions[j].value);
        }
      }
    }
  }, {
    key: "highlightContestant",
    value: function highlightContestant() {
      var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : -1;

      var _iterator = _createForOfIteratorHelper(document.querySelectorAll("[data-highlight=\"true\"]")),
          _step;
      ...
      document.querySelector("#contestant-".concat(index)).highlight = true;
    }
    /**
    ...
    key: "showQuestion",
    value: function showQuestion(update) {
    ...
    key: "showAnswer",
    value: function showAnswer(update) {
      this.questionText.innerHTML = update.state_data.text;
      this.questionPage.show();
      this.gameBoard.hide();
    }
    ...
    key: "getContestant",
    value: function getContestant(index) {
      if (index < 0 || index > 11) return;
      return document.querySelector("#contestant-".concat(index));
    }
  }, {
    key: "logout",
...
var _AbstractView = _interopRequireDefault(require("./AbstractView.js"));
  ...
  return _regenerator["default"].wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          start = new Date();
          window.hostView = new _AbstractView["default"](); // new Menu().init("#menu");
        ...
        case 11:
          ws = _context.sent;
          new _HostController["default"](ws);
          _context.next = 18;
          break;
...
},{"./AbstractView.js":41,"./HostController":42,"./modules/Authenticate.js":44,"./modules/CheckBox.js":45,"./modules/EditorPane.js":46,"./modules/FileOps.js":47,"./modules/GameBoard.js":48,"./modules/Menu.js":49,"./modules/Model":50,"./modules/MultipleChoicePane.js":51,"./modules/QuestionPane.js":52,"@babel/runtime/helpers/asyncToGenerator":24,"@babel/runtime/helpers/interopRequireDefault":31,"@babel/runtime/regenerator":39,"@thaerious/nidget":22}],44:[function(require,module,exports){
"use strict";
...
},{"./googleFields.js":53,"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":27,"@babel/runtime/helpers/interopRequireDefault":31}],45:[function(require,module,exports){
"use strict";
...
},{"@Thaerious/nidget":22,"@babel/runtime/helpers/asyncToGenerator":24,"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":27,"@babel/runtime/helpers/get":28,"@babel/runtime/helpers/getPrototypeOf":29,"@babel/runtime/helpers/inherits":30,"@babel/runtime/helpers/interopRequireDefault":31,"@babel/runtime/helpers/possibleConstructorReturn":34,"@babel/runtime/helpers/wrapNativeSuper":38,"@babel/runtime/regenerator":39}],46:[function(require,module,exports){
"use strict";
...
},{"./Model.js":50,"@babel/runtime/helpers/asyncToGenerator":24,"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":27,"@babel/runtime/helpers/interopRequireDefault":31,"@babel/runtime/regenerator":39}],47:[function(require,module,exports){
...
},{"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":27,"@babel/runtime/helpers/interopRequireDefault":31}],50:[function(require,module,exports){
"use strict";
...
},{"./CheckBox.js":45,"@Thaerious/nidget":22,"@babel/runtime/helpers/asyncToGenerator":24,"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":27,"@babel/runtime/helpers/get":28,"@babel/runtime/helpers/getPrototypeOf":29,"@babel/runtime/helpers/inherits":30,"@babel/runtime/helpers/interopRequireDefault":31,"@babel/runtime/helpers/possibleConstructorReturn":34,"@babel/runtime/helpers/wrapNativeSuper":38,"@babel/runtime/regenerator":39}],52:[function(require,module,exports){
"use strict";
