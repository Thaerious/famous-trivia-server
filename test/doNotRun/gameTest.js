...
describe('Game', function () {
    ...
    describe('start the game', function(){
        ...
        it('has correct question from file', function(){
            game.onInput({action : "start"});
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.round.question, "MC-QUESTION");
        });
    });
    ...
    describe('give players fake scores', function(){
        it('check', function(){
            ...
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.players[0].score, 500);
            assert.strictEqual(update.model.players[1].score, 0);
            assert.strictEqual(update.model.players[2].score, 200);
        });
    });
    ...
    describe('timer expires after bets submitted', function(){
        ...
        it('player #1 gains some loses some', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.players[0].score, 600);
        });
        ...
        it('player #3 loses some', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.players[2].score, 100);
        });
        it('in reveal state', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.round.state, GameModel.STATES.REVEAL);
        });
    });
    ...
    describe('host presses continue (1)', function(){
        ...
        it('jeopardy starts in board state', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.round.state, GameModel.STATES.BOARD);
        });
        ...
        it('current player is \'active player\'', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.round.current_player, "robin");
        });
    ...
    describe('host accepts answer before timer expires', function(){
        ...
        it('score for current player increases by 200', function(){
            game.onInput({action : "accept"});
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.players[0].score, 800);
        });
    ...
    describe('host presses continue (3)', function(){
        ...
        it('active player order updates', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.players[0].name, "alex");
            assert.strictEqual(update.model.players[1].name, "pat");
            assert.strictEqual(update.model.players[2].name, "robin");
        });
        it('current player is \'active player\'', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.round.current_player, "alex");
        });
        it('spent list contains current player', function(){
            let update = game.getUpdate().data;
    ...
    describe('player buzzes in', function(){
        ...
        describe('player has not already answered', function(){
            ...
            it('change current player', function(){
                let update = game.getUpdate().data;
                assert.strictEqual(update.model.round.current_player, "pat");
            });
    ...
    describe('timer expires no buzz in', function(){
        ...
        it('round state set to reveal changes', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(update.model.round.state, 'reveal');
        });
    });
    ...
    describe('all players answers rejected', function(){
        ...
        it('player that answered becomes spent', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(game.model.getRound().isPlayerSpent("robin"), true)
        ...
        it('player that buzzed becomes spent', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(game.model.getRound().isPlayerSpent("alex"), true)
        ...
        it('player that buzzed becomes spent', function(){
            let update = game.getUpdate().data;
            assert.strictEqual(game.model.getRound().isPlayerSpent("pat"), true)
